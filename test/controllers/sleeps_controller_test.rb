...
class SleepsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sleep" do
    assert_difference("Sleep.count") do
      post sleeps_url, params: { sleep: { clockin_at: @sleep.clockin_at, clockout_at: @sleep.clockout_at } }, as: :json
    end
  ...
  test "should update sleep" do
    patch sleep_url(@sleep), params: { sleep: { clockin_at: @sleep.clockin_at, clockout_at: @sleep.clockout_at } }, as: :json
    assert_response :success
  end
